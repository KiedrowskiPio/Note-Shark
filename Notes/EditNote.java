        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(nTitle.isEmpty() || nContent.isEmpty()){
                    Toast.makeText(EditNote.this,"Aby zapisać notatkę wypełnij oba pola", Toast.LENGTH_SHORT).show();
                    return;
                }
                //Pasek ładowania
                ...
                docref.update(note).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(EditNote.this, "Edytowano notatkę", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(getApplicationContext(), MainActivity.class));
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(EditNote.this, "Wystąpił błąd", Toast.LENGTH_SHORT).show();
                        spinner.setVisibility(View.VISIBLE);
                    }
                });
            }
